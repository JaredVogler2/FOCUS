...
class ProductionScheduler:
    ...
    def __init__(self, csv_file_path='scheduling_data.csv', debug=False, late_part_delay_days=1.0):
        ...
        """
        self.csv_file_path = self.resource_path(csv_file_path)
        self.debug = debug
    ...
    def load_data_from_csv(self):
        print(f"\n[DEBUG] Starting to load data from {self.csv_file_path}")
        ...
        try:
            ...
            with open(self.csv_file_path, 'r', encoding='latin-1') as f:
                content = f.read()
    ...
    def scenario_3_simulated_annealing(self, target_earliness=-1, max_iterations=300,
        ...
        for iteration in range(max_iterations):
            ...
            try:
                ...
                distance = abs(metrics['max_lateness'] -
target_earliness)
